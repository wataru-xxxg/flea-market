...
class ItemsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $param = [
            ...
            'imagePath' => '/image/item/Clock.jpg',
            'condition' => 1,
            'price' => 15000,
            'purchased' => 0,
        ];
        ...
        $param = [
            ...
            'imagePath' => '/image/item/Onion.jpg',
            'condition' => 3,
            'price' => 300,
            'purchased' => 0,
        ];
        ...
        $param = [
            ...
            'imagePath' => '/image/item/Shoes.jpg',
            'condition' => 4,
            'price' => 4000,
            'purchased' => 0,
        ];
        ...
        $param = [
            ...
            'imagePath' => '/image/item/Laptop.jpg',
            'condition' => 1,
            'price' => 45000,
            'purchased' => 0,
        ];
        ...
        $param = [
            ...
            'imagePath' => '/image/item/Tumbler.jpg',
            'condition' => 4,
            'price' => 500,
            'purchased' => 0,
        ];
